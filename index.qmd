...
```{=html}
<iframe width="980" height="500" src="https://github.com/NixOS/nixpkgs/blob/nixos-24.11/pkgs/by-name/po/pokemonsay/package.nix" title="pokemonsay"></iframe>
```
...
![](assets/img/rweekly_issue_archive_list.png)
:::
...
## {background-image="assets/img/cal_admin_diagram.svg" background-size="contain"}

## {background-image="assets/img/picard_why.jpg" background-size="contain"}

## {background-image="assets/img/overengineer.jpg" background-size="contain"}
